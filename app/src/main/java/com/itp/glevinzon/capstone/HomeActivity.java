...
public class HomeActivity extends AppCompatActivity implements SpeechDelegate {
            ...
            RxPermissions.getInstance(this)
                    ...
                    .subscribe(granted -> {
                        if (granted) { // Always true pre-M
                            ...
                            Toast.makeText(HomeActivity.this, R.string.permission_required, Toast.LENGTH_LONG);
                        }
                    });
        }
    }
    ...
    private void onSpeakClick() {
        ...
        Speech.getInstance().say(text.getText().toString().trim(), new TextToSpeechCallback() {
            @Override
            public void onStart() {
